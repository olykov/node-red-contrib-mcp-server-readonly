...
// are cheap early guards. Note maxBody only reads the Content-Length header — a
// chunked-encoded request has none and passes straight through, so the body parser's
// own limit is the real backstop; this just rejects oversized requests before parsing.
