...
const { createMcpAuth, secretEqual, acceptsAudience, cimdClientId } = require('../lib/mcp-auth');
...
describe('lib/mcp-auth acceptsAudience', function () {
...
describe('lib/mcp-auth cimdClientId', function () {
...
describe('lib/mcp-auth CIMD client logging', function () {
    const CIMD = 'https://claude.ai/oauth/claude-code-client-metadata';
...
describe('lib/mcp-auth userinfo failure reporting', function () {
...
describe('lib/mcp-auth WWW-Authenticate scope challenge', function () {
